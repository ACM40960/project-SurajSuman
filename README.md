...
<p>[1.]{style="color:#fb8509;"} <a href="#about">About</a><br> [2.]{style="color:#fb8509;"} <a href="#example">Example</a><br> [3.]{style="color:#fb8509;"} <a href="#workflow">Workflow</a><br> [4.]{style="color:#fb8509;"} <a href="#structure">Project structure</a><br> [6.]{style="color:#fb8509;"} <a href="#models">Models</a><br> [7.]{style="color:#fb8509;"} <a href="#results">Results</a><br> [8.]{style="color:#fb8509;"} <a href="#conclusions">Conclusions</a><br> [9.]{style="color:#fb8509;"} <a href="#references">References</a><br> [10.]{style="color:#fb8509;"} <a href="#contributors">Contributors</a><br></p>
...
## [2. Example]{#example style="color:#00bbd6;"}
